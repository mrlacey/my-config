...
This is a list of other Visual Studio extensions to install that are not (yet) supported by vsconfig files.

- https://marketplace.visualstudio.com/items?itemName=MattLaceyLtd.VsixTools2022
- https://marketplace.visualstudio.com/items?itemName=MattLaceyLtd.MauiEssentials
